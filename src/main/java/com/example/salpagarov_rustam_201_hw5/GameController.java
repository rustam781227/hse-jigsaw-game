...
public class GameController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        startStopWatch();
        try {
            SocketConnection.send(new SocketResponse("FIGURE", ""));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void createFigure(int[][] figure) throws IOException, ClassNotFoundException {
    ...
    public void FinishButtonClicked(MouseEvent mouseEvent) throws IOException {
        timeline.stop();
        SocketConnection.send(new SocketResponse("END", stopwatch.getText()));
        //Navigation.navigate("wait.fxml", (Navigation.ReadyListener<WaitController>) controller -> controller.setText("Ждем завершения игры противника"));
